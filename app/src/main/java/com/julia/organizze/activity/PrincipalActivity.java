...
import com.julia.organizze.MainActivity;
import com.julia.organizze.R;
import com.julia.organizze.adapter.AdapterMovimentacao;
...
public class PrincipalActivity extends AppCompatActivity {
    ...
    public void excluirMovimentacao(final RecyclerView.ViewHolder viewHolder){
        ...
        alertDialog.setMessage("Você tem certeza que deseja realmente excluir ess movimentação?");
    ...
    public void configuraCalendarView(){
        CharSequence meses[] = {"Janeiro", "Fevereiro", "Março", "Abril", "Maio", "Junho", "Júlio", "Agosto", "Setembro", "Outubro", "Novembro", "Desembro"};
